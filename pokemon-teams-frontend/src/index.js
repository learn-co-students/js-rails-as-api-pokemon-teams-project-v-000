...
document.addEventListener("DOMContentLoaded", () => {
  // WWhen a user loads the page, they should see all trainers iwth current team of Pokemon from seeded data
  fetchTrainers();
});
...
// When a user hits "Add Pokemon" and they have space on their team, they get a new Pokemon
...
// Whenever a user hits "Release Pokemon" on a specific Pokemon team, that specific Pokemon should be released.
